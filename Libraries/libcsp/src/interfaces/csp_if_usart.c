...
int csp_usart_tx(const csp_route_t * ifroute, csp_packet_t * packet) {
 ...
 */
void csp_usart_rx(csp_iface_t * iface, const uint8_t * buf, size_t len, void * pxTaskWoken) {
...
int csp_usart_add_interface(csp_iface_t * iface) {
